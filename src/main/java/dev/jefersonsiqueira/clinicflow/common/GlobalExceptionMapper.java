...
import dev.jefersonsiqueira.clinicflow.auth.InvalidRefreshTokenException;
import dev.jefersonsiqueira.clinicflow.auth.WeakPasswordException;
  ...
  public Response toResponse(Exception exception) {
    Response response =
        switch (exception) {
          ...
          case InvalidRefreshTokenException e -> error(401, ErrorCategory.UNAUTHORIZED, null, e.getMessage());
          case WeakPasswordException e -> error(422, ErrorCategory.VALIDATION, "newPassword", e.getMessage());
